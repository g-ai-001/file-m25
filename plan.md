...
### 0.8.2 (已完成版本)
**目标**: 修复标题栏UI问题
- [x] 修复Issue #3: 标题栏高度过大问题（面包屑导航单独一行显示）
- [x] 修复Issue #3: 标题栏按钮数量精简至3个
- [x] 修复Issue #3: 面包屑导航支持横向滚动

### 0.10.0 (已完成版本)
**目标**: 文件分类视图、存储分析器
- [x] 文件分类视图（按图片/视频/音频/文档/应用/压缩包分类浏览）
- [x] 存储分析器（显示各类型文件占用的空间）

### 0.9.0 (已完成版本)
**目标**: PDF预览、回收站
- [x] PDF预览功能（点击PDF文件时全屏预览，支持缩放和页面导航）
- [x] 回收站功能（删除文件暂存到回收站，支持恢复和彻底删除）

### 0.11.0 (已完成版本)
**目标**: 文本文件预览
- [x] 文本文件预览功能（点击TXT文件时全屏预览，支持大文件分页加载）
- [x] 文本预览支持字体大小调节
- [x] 文本预览支持搜索功能
